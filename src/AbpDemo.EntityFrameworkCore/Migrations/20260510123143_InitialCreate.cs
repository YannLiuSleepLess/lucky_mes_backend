        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AffectedProductIds = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AffectedBomVersionIds = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AffectedProcessRouteIds = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MesEngineeringChanges", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BomVersionId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    Version = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Status = table.Column<int>(type: "int", nullable: false),
                    TotalStandardTime = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MesProcessRoutes", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductName = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Type = table.Column<int>(type: "int", nullable: false),
                    SpecLength = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SpecWidth = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SpecHeight = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SpecThickness = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SpecWeight = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    SpecCustomSpecs = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Unit = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsSerialTraced = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    YieldRate = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                name: "MesProcessDocuments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ProcessRouteId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MesProcessDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MesProcessDocuments_MesProcessRoutes_ProcessRouteId",
                        column: x => x.ProcessRouteId,
                        principalTable: "MesProcessRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                name: "MesProcessParameters",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ProcessStepId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ParameterName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ParameterCode = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Unit = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RangeMinValue = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    RangeMaxValue = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    RangeDefaultValue = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    RangeTolerance = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    ...
                    UCL = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    LCL = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MesProcessParameters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MesProcessParameters_MesProcessRoutes_ProcessStepId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ProcessRouteId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    StepNo = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StepName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Sequence = table.Column<int>(type: "int", nullable: false),
                    EquipmentTypeId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    WorkCenterId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    StandardTime = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    IsCritical = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsInspectionRequired = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    InspectionType = table.Column<int>(type: "int", nullable: true),
                    IsSortingStep = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    SortingType = table.Column<byte>(type: "tinyint unsigned", nullable: true),
                    ThresholdA = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ThresholdB = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    ThresholdC = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    NextStepForGradeA = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    NextStepForGradeB = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    NextStepForGradeC = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    InputProductId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    OutputProductId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    YieldRate = table.Column<decimal>(type: "decimal(65,30)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MesProcessSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MesProcessSteps_MesProcessRoutes_ProcessRouteId",
                        column: x => x.ProcessRouteId,
                        principalTable: "MesProcessRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "MesProductVersions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ProductId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    VersionNo = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MesProductVersions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MesProductVersions_MesProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "MesProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComponentProductName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Quantity = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    ScrapRate = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Unit = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Sequence = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MesBomItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MesBomItems_MesProductVersions_ProductVersionId",
                        column: x => x.ProductVersionId,
                        principalTable: "MesProductVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MesProcessDocuments_ProcessRouteId",
                table: "MesProcessDocuments",
                column: "ProcessRouteId");

            migrationBuilder.CreateIndex(
                name: "IX_MesProcessParameters_ProcessStepId",
                table: "MesProcessParameters",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MesProcessSteps_ProcessRouteId",
                table: "MesProcessSteps",
                column: "ProcessRouteId");
